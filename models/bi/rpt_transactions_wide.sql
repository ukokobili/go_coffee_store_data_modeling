-- Wide view for BI: one row per transaction with friendly attributes
with
...
select
    ...
    -- measures
    sales.transaction_seq,
    sales.customer_sales_seq,
    sales.customer_lifetime_value,
    sales.nvsr,
    sales.fdos,
    sales.quantity,
    sales.gross_total,
